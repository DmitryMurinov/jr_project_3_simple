...
public class SecondStepServletTest {
    ...
    public void testPositiveScenario_livePick_leadToLiveStep() throws ServletException, IOException {
        ...
        when(request.getRequestDispatcher("/steps/secondStepLive.jsp")).thenReturn(dispatcher);

        new SecondStepServlet().doGet(request, response);
    ...
    public void testPositiveScenario_diePick_leadToDieStep() throws ServletException, IOException {
        ...
        when(request.getRequestDispatcher("/steps/secondStepDie.jsp")).thenReturn(dispatcher);
